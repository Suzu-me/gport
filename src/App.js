  ...
  showPage() {
    switch (this.state.page) {
      ...
      case 'CONNECT':
        return <Connect />
      case 'SURPRISE':
        return <Surprise onClick={this.changePage} playing={this.state.playing} togglePlaying={this.togglePlaying} />
      default:
    ...
    return (
      <div className="App">
        <div className="col-12 pl-0 pr-0">
          {this.state.page === 'START' || this.state.page === 'PLAYER' || this.state.page === 'SURPRISE'
            ? null 
